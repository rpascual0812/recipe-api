"""
Test cases for the user API endpoints in a Django application.
"""
...
class PublicUserApiTests(TestCase):
    """Test the public user API endpoints."""
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email="test@example.com", password="testpassword123")
